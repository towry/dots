...
- **exa**: Latest web context (versions, best practices, docs); Use for web search and scraping. Not for github repo search/file reading, use `github` mcp tools for that.
