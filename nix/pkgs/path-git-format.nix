...
let
  tarballUrl =
    if version == "latest" then
      "https://github.com/towry/path-git-format/releases/latest/download/path-git-format.tar.gz"
    else
      "https://github.com/towry/path-git-format/releases/download/${version}/path-git-format-${version}-${system}.tar.gz";
  sha256-map = {
