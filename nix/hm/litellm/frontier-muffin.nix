...
[
  {
    ...
    litellm_params = {
      ...
      max_tokens = getMaxOutputTokens "claude-sonnet-4.5";
    ...
    model_info = {
      max_input_tokens = getMaxInputTokens "claude-sonnet-4.5";
      max_output_tokens = getMaxOutputTokens "claude-sonnet-4.5";
    };
  }
  # {
  #   model_name = "frontier-muffin";
