...
let
  ...
  providerTokens = {
    ...
    github_copilot = {
      ...
      "gpt-5-mini" = { input = 128000; output = 128000; };
      "gpt-5.1" = { input = 128000; output = 128000; };
      "gpt-5.1-codex" = { input = 128000; output = 128000; };
      "gpt-5.1-codex-mini" = { input = 128000; output = 128000; };
      "gpt-4.1" = { input = 32768; output = 32768; };
      ...
      "claude-opus-41" = { input = 80000; output = 16000; };
      "gemini-2.5-pro" = { input = 1000000; output = 8192; };
      "gemini-2.5-flash" = { input = 1000000; output = 8192; };
      "gemini-3-pro-preview" = { input = 1000000; output = 8192; };
      "grok-code-fast-1" = { input = 128000; output = 64000; };
      "oswe-vscode-prime" = { input = 128000; output = 64000; };
    };
    ...
    openai = {
      ...
      "gpt-5.1-codex" = { input = 400000; output = 128000; };
      "gpt-4.1" = { input = 1047576; output = 32768; };
      "gpt-4o" = { input = 128000; output = 16384; };
    };
    ...
    anthropic = {
      ...
      "claude-haiku-4-5" = { input = 200000; output = 64000; }; # alternate naming
      "claude-sonnet-4" = { input = 200000; output = 64000; };
      "claude-sonnet-4.5" = { input = 200000; output = 64000; };
      "claude-sonnet-4-5" = { input = 200000; output = 8192; }; # alternate naming
      "claude-opus-41" = { input = 200000; output = 32000; };
      "claude-opus-4-1" = { input = 200000; output = 32000; }; # alternate naming
    };
    ...
    google = {
      ...
      "gemini-3-pro-preview" = { input = 1000000; output = 65000; };
    };

    # xAI provider
    xai = {
      "grok-code-fast-1" = { input = 32768; output = 10000; };
    };
    ...
    zhipuai = {
      "glm-4.6" = { input = 204800; output = 131072; };
      "glm-4.5-air" = { input = 98304; output = 98304; };
    };

    # Kimi / Moonshot AI provider
    moonshot = {
      "kimi-k2-thinking" = { input = 262144; output = 262144; };
    };
    ...
    opencodeai = {
      ...
      "gpt-5.1-codex" = { input = 400000; output = 128000; };
      "claude-haiku-4-5" = { input = 200000; output = 64000; };
      "claude-sonnet-4-5" = { input = 1000000; output = 64000; };
      "gemini-3-pro" = { input = 1000000; output = 65000; };
      "kimi-k2" = { input = 262144; output = 262144; };
      "big-pickle" = { input = 200000; output = 128000; };
      "grok-code" = { input = 128000; output = 64000; };
      "qwen3-coder" = { input = 262144; output = 65536; };
    };

    # Alibaba Dashscope provider
    dashscope = {
      "qwen3-coder-plus" = { input = 262144; output = 65536; };
      "qwen3-coder-480b-a35b-instruct" = { input = 262144; output = 65536; };
      "qwen3-max" = { input = 262144; output = 65536; };
    };
  };
    ...
    let
      ...
      providerLookup =
        if provider != null && lib.hasAttr provider providerTokens then
          ...
          in
          if lib.hasAttr model providerModels then
            builtins.getAttr model providerModels
          else
            null
        else
          null;
      ...
      fallbackLookup =
        let
          tryProviders = [ "github_copilot" "openai" "anthropic" "google" "zhipuai" "moonshot" ];
          findInProvider = p:
            if lib.hasAttr p providerTokens then
              let providerModels = builtins.getAttr p providerTokens;
              in if lib.hasAttr model providerModels then
                builtins.getAttr model providerModels
              else null
            else null;
          results = builtins.filter (x: x != null) (map findInProvider tryProviders);
        in
        if builtins.length results > 0 then
